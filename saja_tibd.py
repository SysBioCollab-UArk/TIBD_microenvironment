...
Parameter('k_Beta_synth', 0.01) # Temporarly set it to 0
...
Observable('OB', B())
Observable('OB_L', B(state='L'))
Observable('OB_X', B(state='x'))
Observable('OC', C())
Observable('PTHrP', P())
